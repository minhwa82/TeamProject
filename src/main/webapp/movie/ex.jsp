...
-->
    <%
    // 파라메터 설정
	String targetDt = request.getParameter("targetDt")==null?"20230301":request.getParameter("targetDt");			//조회일자
...
<body>
	...
	<c:forEach items="${dailyResult.boxOfficeResult.dailyBoxOfficeList}" var="boxoffice">
		<tr>
			...
			<input type="hidden" name="rank" value="${boxoffice.rank }">
		</tr>
